...
end_marker = "  return ("  # This matches the start of the return block of the main page, wait, let's find the closing brace of showModal block

# Let's find exactly "{showModal && (" starting from line 900
start_idx = text.find(start_marker, 9000) # search from index 9000 onwards
if start_idx == -1:
    start_idx = text.find(start_marker)

# Let's find the closing tag of showModal.
# The showModal starts with {showModal && (
# And ends with:
#       )}
#     </div>
#   );
...
if start_idx != -1 and end_idx != -1:
    ...
    new_modal_block = """      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-y-auto">
          <div
            className={`bg-white w-full rounded-3xl shadow-xl overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95 duration-200 transition-all ${
              activeTabInModal !== "basic" ? "max-w-4xl" : "max-w-xl"
            }`}
          >
            {/* Modal Header */}
            ...
            {/* Tab Navigation (luôn hiển thị khi Thêm hoặc Sửa) */}
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                  ...
                  {activeTabInModal === "variants" && (
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="border border-gray-100 rounded-2xl overflow-hidden bg-white shadow-sm overflow-auto max-h-[35vh]">
    ...
    # Replace the block
    new_text = text[:start_idx] + new_modal_block + text[end_idx + 8:] # 8 is length of "      )}"
