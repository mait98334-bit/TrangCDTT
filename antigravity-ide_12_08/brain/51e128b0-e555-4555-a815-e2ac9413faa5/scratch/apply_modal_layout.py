...
# Find the index of the start comment: {/* Modal Dialog Thêm/Sửa sản phẩm (Thông tin chung, Ảnh phụ, Biến thể) */}
start_line_idx = -1
...
# Find the end of the file layout markers
end_line_idx = -1
...
print(f"Replacing modal section lines {start_line_idx} to {end_line_idx} with the new fixed-footer layout.")
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-y-auto">
                    <div className={`bg-white w-full rounded-3xl shadow-xl overflow-hidden flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95 duration-200 transition-all ${
                        ...
                        {activeTabInModal === 'basic' ? (
                            ...
                            /* TAB 2 & 3: ẢNH PHỤ HOẶC BIẾN THỂ */
                            <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
                                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                                    {activeTabInModal === 'images' ? (
                                        /* CONTENT TAB 2: QUẢN LÝ ẢNH PHỤ */
                                        ...
                                        /* CONTENT TAB 3: QUẢN LÝ BIẾN THỂ */
                                        <div className="space-y-6">
...
print("Fixed-footer layout applied successfully!")
