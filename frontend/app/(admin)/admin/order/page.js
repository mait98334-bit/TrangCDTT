                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-gray-50/50 p-5 rounded-2xl border border-gray-100">
                                <div className="space-y-2.5 text-sm">
                                    ...
                                    <div><span className="text-gray-500 font-medium">Họ tên:</span> <span className="font-semibold text-gray-800">{selectedOrderDetails.order.fullname}</span></div>
                                    <div><span className="text-gray-500 font-medium">Điện thoại:</span> <span className="font-semibold text-gray-800">{selectedOrderDetails.order.phone}</span></div>
                                    <div><span className="text-gray-500 font-medium">Địa chỉ:</span> <span className="font-semibold text-gray-800">{selectedOrderDetails.order.address}</span></div>
